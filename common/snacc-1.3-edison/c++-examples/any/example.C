...
// DATE:   92
//
// $Header: /data/cvs/prototype/story/src/public/tools/snacc-1.3/c++-examples/any/example.C,v 1.1 2006/10/16 09:02:02 joywu Exp $
// $Log: example.C,v $
// Revision 1.1  2006/10/16 09:02:02  joywu
// no message
//
