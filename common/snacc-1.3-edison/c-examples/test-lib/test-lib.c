 ...
 * MS 92
 *
 * $Header: /data/cvs/prototype/story/src/public/tools/snacc-1.3/c-examples/test-lib/test-lib.c,v 1.1 2006/10/16 09:04:17 joywu Exp $
 * $Log: test-lib.c,v $
 * Revision 1.1  2006/10/16 09:04:17  joywu
 * no message
 *
